...
public class MysteriousTincture extends Item {
    ...
    public String getComponent(ItemStack stack){
        return Objects.requireNonNull(stack.get(TINCTURE_ITEM)).toString().replace("TinctureIngredientComponent[ingredient=","").replace("]","");
    }
