...
public class ModEffects implements ModInitializer {
    ...
    static {
        ...
        HADES_EFFECT = register("hadeshellfire", new HadesHellfireEffect(StatusEffectCategory.HARMFUL, 5968149));
        AETHERIAL_SACRIFICE_EFFECT = register("aetherialsacrifice", new AetherialSacrificeEffect(StatusEffectCategory.HARMFUL, 16775920).addAttributeModifier(EntityAttributes.GENERIC_GRAVITY, Identifier.of(Parachymistry.MOD_ID,"effect.aetherialsacrifice"),-1.05f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
        SWIFTSTRIDE_EFFECT = register("swiftstride", new SwiftStrideEffect(StatusEffectCategory.BENEFICIAL,52377).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_EFFICIENCY,Identifier.of(Parachymistry.MOD_ID,"effect.swiftstride"),1f, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_STEP_HEIGHT,Identifier.of(Parachymistry.MOD_ID,"effect.swiftstridestep"),1f,EntityAttributeModifier.Operation.ADD_VALUE));
        IRONWARD_EFFECT = register("ironward", new IronWardEffect(StatusEffectCategory.BENEFICIAL,10658512).addAttributeModifier(EntityAttributes.GENERIC_ARMOR,Identifier.of(Parachymistry.MOD_ID,"effect.ironward"), 4f, EntityAttributeModifier.Operation.ADD_VALUE));
        VENOMOUS_RECIPROCATION_EFFECT = register("venomous_reciprocation", new VenomousReciprocationEffect(StatusEffectCategory.BENEFICIAL,16933));
        KARMIC_SHIELDING_EFFECT = register("karmic_shielding",new KarmicShieldingEffect(StatusEffectCategory.BENEFICIAL,16445630).addAttributeModifier(EntityAttributes.GENERIC_MAX_ABSORPTION,Identifier.of(Parachymistry.MOD_ID,"effect.karmic_shielding"),10f, EntityAttributeModifier.Operation.ADD_VALUE));
        STEADFAST_EFFECT = register("steadfast",new IronWardEffect(StatusEffectCategory.BENEFICIAL,4929057).addAttributeModifier(EntityAttributes.GENERIC_EXPLOSION_KNOCKBACK_RESISTANCE,Identifier.of(Parachymistry.MOD_ID,"effect.steadfast"),1f, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE,Identifier.of(Parachymistry.MOD_ID,"effect.steadfastresistance"),1f,EntityAttributeModifier.Operation.ADD_VALUE));
    }
