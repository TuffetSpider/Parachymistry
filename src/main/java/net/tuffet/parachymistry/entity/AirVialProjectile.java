...
public class AirVialProjectile extends ThrownItemEntity {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (!this.getWorld().isClient) {
            ...
            if(entity.getWorld().getGameRules().getBoolean(SHOULD_HAVE_DAMAGING_VIALS)) entity.damage(this.getDamageSources().windCharge(this, (LivingEntity) this.getOwner()), (float)5.0);
            this.discard();
        }
    }
